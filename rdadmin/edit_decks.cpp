...
//
//      $Id: edit_decks.cpp,v 1.31 2008/04/03 16:50:06 fredg Exp $
//
...
EditDecks::EditDecks(RDStation *station,QWidget *parent,const char *name)
  : QDialog(parent,name,true)
{
  ...
  // Sample Rate
  //
  edit_samprate_box=new QComboBox(this,"edit_samprate_box");
  edit_samprate_box->setGeometry(125,160,90,24);
  edit_samprate_box->setInsertionPolicy(QComboBox::NoInsertion);
  label=new QLabel(edit_samprate_box,tr("Sample Rate:"),this,
			     "edit_samprate_label");
  label->setGeometry(10,160,110,24);
  label->setAlignment(AlignRight|AlignVCenter);
  ...
  edit_swstation_box->setGeometry(125,214,250,24);
  ...
  edit_swstation_label->setGeometry(10,214,110,24);
  ...
  edit_swmatrix_box->setGeometry(125,238,250,24);
  ...
  edit_swmatrix_label=new QLabel(edit_swmatrix_box,tr("Switcher Matrix:"),this,
			     "edit_swmatrix_label");
  edit_swmatrix_label->setGeometry(10,238,110,24);
  ...
  edit_swoutput_box->setGeometry(125,262,250,24);
  ...
  edit_swoutput_label=new QLabel(edit_swoutput_box,tr("Switcher Output:"),this,
			     "edit_swoutput_label");
  edit_swoutput_label->setGeometry(10,262,110,24);
  ...
  edit_swdelay_box->setGeometry(125,286,40,24);
  ...
  edit_swdelay_label=new QLabel(edit_swdelay_box,tr("Switcher Delay:"),this,
			     "edit_swdelay_label");
  edit_swdelay_label->setGeometry(10,286,110,24);
  ...
  edit_swdelay_unit=new QLabel(edit_swdelay_box,tr("1/10 sec"),this,
			     "edit_swdelay_unit");
  edit_swdelay_unit->setGeometry(170,286,60,24);
  ...
  label->setGeometry(10,300,100,24);
  label->setFont(big_font);
  ...
  edit_channels_box->setGeometry(125,324,60,24);
  ...
  edit_threshold_box->setGeometry(125,348,70,24);
  ...
  label->setGeometry(10,348,110,24);
  label->setAlignment(AlignRight|AlignVCenter);
  ...
  // Populate Data
  //
  if(edit_station->scanned()) {
    edit_record_selector->setMaxCards(station->cards());
    edit_play_selector->setMaxCards(station->cards());
    edit_audition_selector->setMaxCards(station->cards());
    for(int i=0;i<edit_record_selector->maxCards();i++) {
      edit_record_selector->setMaxPorts(i,station->cardInputs(i));
      edit_play_selector->setMaxPorts(i,station->cardOutputs(i));
      edit_audition_selector->setMaxPorts(i,station->cardOutputs(i));
    }
  }
  else {
  ...
  edit_samprate_box->insertItem("44100");
  edit_samprate_box->insertItem("48000");
...
void EditDecks::ReadRecord(int chan)
{
  ...
  if((chan>0)&&(chan<(MAX_DECKS+1))) {       // Record Deck
    ...
    switch(edit_record_deck->defaultSamprate()) {
	case 32000:
	  edit_samprate_box->setCurrentItem(0);
	  break;
	case 44100:
	  edit_samprate_box->setCurrentItem(1);
	  break;
	case 48000:
	  edit_samprate_box->setCurrentItem(2);
	  break;
    }
...
void EditDecks::WriteRecord(int chan)
{
  ...
  if((chan>0)&&(chan<(MAX_DECKS+1))) {     // Record Deck
    ...
    edit_record_deck->setDefaultSamprate(temp);

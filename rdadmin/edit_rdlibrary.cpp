...
//
//      $Id: edit_rdlibrary.cpp,v 1.30.2.1 2009/09/04 01:29:49 cvs Exp $
//
...
EditRDLibrary::EditRDLibrary(RDStation *station,unsigned instance,
  ...
  : QDialog(parent,name,true)
{
  ...
  lib_lib=new RDLibraryConf(station->name(),instance);
  ...
  // Sample Rate
  //
  lib_samprate_box=new QComboBox(this,"lib_samperate_box");
  lib_samprate_box->setGeometry(160,304,100,19);
  QLabel *lib_samprate_label=new QLabel(lib_samprate_box,tr("&Sample Rate:"),
					this,"lib_samprate_label");
  lib_samprate_label->setGeometry(20,304,130,19);
  ...
  lib_bitrate_box->setGeometry(160,328,130,19);
  QLabel *lib_bitrate_label=new QLabel(lib_bitrate_box,tr("&Bitrate:"),this,
				       "lib_bitrate_label");
  lib_bitrate_label->setGeometry(25,328,130,19);
  ...
  lib_editor_box->setGeometry(160,352,60,19);
  ...
  QLabel *lib_editor_label=new QLabel(lib_editor_box,
				      ...
				      "lib_editor_label");
  lib_editor_label->setGeometry(25,352,130,19);
  ...
  switch(lib_lib->defaultSampleRate()) {
      case 32000:

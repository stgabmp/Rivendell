...
//
//      $Id: edit_cast.cpp,v 1.5.2.3 2009/05/26 18:33:30 cvs Exp $
//
  ...
  : QDialog(parent,name,true)
{
  ...
  cast_item_medialink_edit->setGeometry(115,10,sizeHint().width()-125,19);
  ...
  cast_item_medialink_label->setGeometry(20,10,90,19);
  ...
  cast_item_title_edit->setGeometry(115,ypos,sizeHint().width()-125,19);
  ...
  cast_item_title_label->setGeometry(20,ypos,90,19);
  ...
  cast_item_author_edit->setGeometry(115,ypos+22,sizeHint().width()-125,19);
  ...
  cast_item_author_label->setGeometry(20,ypos+22,90,19);
  ...
  cast_item_category_edit->setGeometry(115,ypos+44,sizeHint().width()-125,19);
  ...
  cast_item_category_label->setGeometry(20,ypos+44,90,19);
  ...
  cast_item_link_edit->setGeometry(115,ypos+66,sizeHint().width()-125,19);
  ...
  cast_item_link_label->setGeometry(20,ypos+66,90,19);
  ...
  cast_item_description_label->setGeometry(20,ypos+88,90,19);
  ...
  cast_item_sourcetext_edit->setGeometry(115,ypos+169,sizeHint().width()-125,19);
  ...
  cast_item_sourcetext_label->setGeometry(20,ypos+169,90,19);
  ...
  cast_item_sourceurl_edit->setGeometry(115,ypos+191,sizeHint().width()-125,19);
  ...
  cast_item_sourceurl_label->setGeometry(20,ypos+191,90,19);
  ...
  cast_item_comments_edit->setGeometry(115,ypos+213,sizeHint().width()-125,19);
  ...
  cast_item_comments_label->setGeometry(10,ypos+213,100,19);
  ...
  while(q->next()) {
    ...
    cast_aux_edits.back()->
      setGeometry(115,cast_ypos,sizeHint().width()-125,19);
    ...
    label->setGeometry(20,cast_ypos,90,19);
    label->setFont(font);
  ...
  cast_item_effective_edit->
    setGeometry(115,cast_ypos,165,19);
  ...
  cast_item_origin_edit->setGeometry(115,cast_ypos,165,19);
  ...
  cast_item_origin_label->setGeometry(20,cast_ypos,90,19);
  ...
  cast_item_expiration_box->setGeometry(115,cast_ypos,50,19);
  ...
  cast_item_expiration_label=
    new QLabel(cast_item_expiration_edit,tr("Expires At:"),this,
	       "cast_item_expiration_label");
  cast_item_expiration_label->setGeometry(20,cast_ypos,90,19);
  cast_item_expiration_label->setFont(font);
  cast_item_expiration_label->
    setAlignment(AlignRight|AlignVCenter|ShowPrefix);
  cast_item_expiration_button=
    new QPushButton(this,"cast_item_expiration_button");
  cast_item_expiration_button->setGeometry(290,cast_ypos-3,50,25);
  ...
  cast_item_expiration_label->setEnabled(cast_status!=RDPodcast::StatusExpired);
  cast_item_expiration_button->setEnabled(cast_status!=RDPodcast::StatusExpired);
  ...
  label->setGeometry(20,cast_ypos-1,90,19);
  label->setFont(font);
  label->setAlignment(AlignRight|AlignVCenter|ShowPrefix);
  label->setEnabled(cast_status!=RDPodcast::StatusExpired);
  rbutton->setEnabled(cast_status!=RDPodcast::StatusExpired);
  ...
  cast_item_medialink_edit->
    setText(cast_feed->audioUrl(cast_feed->mediaLinkMode(),cast_cast->id()));
  ...
  cast_item_expiration_edit->setDateTime(cast_cast->originDateTime().
...
{
  QDate current_date=QDate::currentDate();
  QDateTime datetime=cast_item_expiration_edit->dateTime();
  QDate date=datetime.date();
  ...
  if(dd->exec(&date)==0) {
    datetime.setDate(date);
    cast_item_expiration_edit->setDateTime(datetime);
  }
  delete dd;
}
...
void EditCast::okData()
{
  ...
  if(cast_item_status_group->isEnabled()) {
    if(cast_item_expiration_box->currentItem()) {
      cast_cast->setShelfLife(cast_cast->originDateTime().
			      daysTo(cast_item_expiration_edit->dateTime()));
    }
    else {
  ...
  cast_feed->setLastBuildDateTime(QDateTime(QDate::currentDate(),
				       QTime::currentTime()));
  done(0);
}

...
//
//      $Id: edit_upload.cpp,v 1.15.2.2 2008/11/19 16:49:55 fredg Exp $
//
  ...
  : QDialog(parent,name,true)
{
  ...
  edit_normalize_label->setGeometry(215,208,45,20);
  ...
  edit_normalize_unit->setGeometry(310,208,40,20);
  ...
  label->setGeometry(47,236,90,19);
  label->setFont(label_font);
  ...
  edit_mon_button->setGeometry(20,255,20,20);
  label=new QLabel(edit_mon_button,
		   tr("Monday"),this,"edit_mon_label");
  label->setGeometry(40,255,115,20);
  ...
  edit_tue_button->setGeometry(115,255,20,20);
  label=new QLabel(edit_tue_button,
		   tr("Tuesday"),this,"edit_tue_label");
  label->setGeometry(135,255,115,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_wed_button->setGeometry(215,255,20,20);
  label=new QLabel(edit_wed_button,
		   tr("Wednesday"),this,"edit_wed_label");
  label->setGeometry(235,255,115,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_thu_button->setGeometry(335,255,20,20);
  label=new QLabel(edit_thu_button,
		   tr("Thursday"),this,"edit_thu_label");
  label->setGeometry(355,255,115,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_fri_button->setGeometry(440,255,20,20);
  label=new QLabel(edit_fri_button,
		   tr("Friday"),this,"edit_fri_label");
  label->setGeometry(460,255,40,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_sat_button->setGeometry(130,280,20,20);
  label=new QLabel(edit_sat_button,
		   tr("Saturday"),this,"edit_sat_label");
  label->setGeometry(150,280,60,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_sun_button->setGeometry(300,280,20,20);
  label=new QLabel(edit_sun_button,
		   tr("Sunday"),this,"edit_sun_label");
  label->setGeometry(320,280,60,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_oneshot_box->setGeometry(20,315,15,15);
  label=new QLabel(edit_oneshot_box,
		   tr("Make OneShot"),this,"edit_oneshot_label");
  label->setGeometry(40,313,115,20);
  label->setFont(label_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_settings.setSampleRate(edit_recording->samprate());
...
void EditUpload::selectCartData()
{
  ...
  RDCutDialog *cut=new RDCutDialog(&edit_cutname,rdstation_conf,edit_filter);
  switch(cut->exec()) {
      case 0:
...
void EditUpload::okData()
{
  ...
  QString protocol=url.protocol();
  if((protocol!="ftp")&&(protocol!="smb")&&(protocol!="file")) {
    QMessageBox::warning(this,
			 tr("Invalid URL"),tr("Unsupported URL protocol!"));
    return;
  }
  if((protocol=="smb")&&((!url.validSmbShare())||(url.smbPath()=="/"))) {
    QMessageBox::warning(this,
			 tr("Invalid URL"),tr("The URL is invalid!"));
    return;
  }
  if(!CheckEvent(false)) {
    QMessageBox::warning(this,tr("Duplicate Event"),
...
void EditUpload::paintEvent(QPaintEvent *e)
{
  ...
  p->drawRect(10,244,sizeHint().width()-20,62);
  p->end();
}
...
void EditUpload::Save()
{
  ...
  edit_recording->setSamprate(edit_settings.sampleRate());

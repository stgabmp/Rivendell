...
//
//      $Id: edit_download.cpp,v 1.15.2.1 2008/11/14 21:30:55 fredg Exp $
//
  ...
  : QDialog(parent,name,true)
{
  ...
  label->setGeometry(47,229,90,19);
  label->setFont(label_font);
  ...
  edit_mon_button->setGeometry(20,248,20,20);
  label=new QLabel(edit_mon_button,
		   tr("Monday"),this,"edit_mon_label");
  label->setGeometry(40,248,115,20);
  ...
  edit_tue_button->setGeometry(115,248,20,20);
  label=new QLabel(edit_tue_button,
		   tr("Tuesday"),this,"edit_tue_label");
  label->setGeometry(135,248,115,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_wed_button->setGeometry(215,248,20,20);
  label=new QLabel(edit_wed_button,
		   tr("Wednesday"),this,"edit_wed_label");
  label->setGeometry(235,248,115,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_thu_button->setGeometry(335,248,20,20);
  label=new QLabel(edit_thu_button,
		   tr("Thursday"),this,"edit_thu_label");
  label->setGeometry(355,248,115,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_fri_button->setGeometry(440,248,20,20);
  label=new QLabel(edit_fri_button,
		   tr("Friday"),this,"edit_fri_label");
  label->setGeometry(460,248,40,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_sat_button->setGeometry(130,273,20,20);
  label=new QLabel(edit_sat_button,
		   tr("Saturday"),this,"edit_sat_label");
  label->setGeometry(150,273,60,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_sun_button->setGeometry(300,273,20,20);
  label=new QLabel(edit_sun_button,
		   tr("Sunday"),this,"edit_sun_label");
  label->setGeometry(320,273,60,20);
  label->setFont(day_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
  ...
  edit_oneshot_box->setGeometry(20,310,15,15);
  label=new QLabel(edit_oneshot_box,
		   tr("Make OneShot"),this,"edit_oneshot_label");
  label->setGeometry(40,308,115,20);
  label->setFont(label_font);
  label->setAlignment(AlignLeft|AlignVCenter|ShowPrefix);
...
void EditDownload::selectCartData()
{
  ...
  RDCutDialog *cut=new RDCutDialog(&edit_cutname,rdstation_conf,edit_filter,
				   NULL,catch_user->name(),false,true);
  switch(cut->exec()) {
      case 0:
...
void EditDownload::paintEvent(QPaintEvent *e)
{
  ...
  p->drawRect(10,237,sizeHint().width()-20,62);
  p->end();
}

...
//
//      $Id: btss164.cpp,v 1.10 2008/10/01 13:10:15 fredg Exp $
//
...
BtSs164::BtSs164(RDMatrix *matrix,QObject *parent,const char *name)
  : QObject(parent,name)
{
  //
...
void BtSs164::gpiOneshotData(void *data)
{
...
void BtSs164::gpoOneshotData(void *data)
{

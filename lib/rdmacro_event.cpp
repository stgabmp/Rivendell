...
//
//      $Id: rdmacro_event.cpp,v 1.17 2007/10/04 20:53:28 dmills Exp $
//
...
{
  vector<RDMacro>::iterator it=event_cmds.begin()+line;

  event_cmds.insert(it,1,RDMacro());
  event_cmds.at(line)=*cmd;
}

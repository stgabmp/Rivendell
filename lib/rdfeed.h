...
//
//      $Id: rdfeed.h,v 1.5.2.6 2009/09/04 01:29:49 cvs Exp $
//
...
class RDFeed : public QObject
{
 ...
 public:
  ...
  unsigned postCut(RDStation *station,const QString &cutname,Error *err);
 ...
 private:
  QString GetImportCommand(RDStation *station,const QString &srcfile,
			   QString *destfile,Error *err) const;
  QString GetExportCommand(RDStation *station,const QString &srcfile,
			   QString *destfile,Error *err) const;

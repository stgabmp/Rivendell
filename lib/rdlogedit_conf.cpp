...
//
//      $Id: rdlogedit_conf.cpp,v 1.11 2008/08/04 19:05:33 fredg Exp $
//
...
unsigned RDLogeditConf::sampleRate() const
{
  return RDGetSqlValue("RDLOGEDIT","STATION",lib_station,"SAMPRATE").toUInt();
}


void RDLogeditConf::setSampleRate(unsigned rate) const
{

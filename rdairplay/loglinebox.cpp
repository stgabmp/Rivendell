...
//
//      $Id: loglinebox.cpp,v 1.83.2.2 2010/02/08 23:50:14 cvs Exp $
//
  ...
  : QWidget(parent,name)
{
  ...
  line_title_label->setGeometry(5,18,sizeHint().width()-10,16);
  ...
  line_description_label->setGeometry((sizeHint().width()/2),48,(sizeHint().width()/2 -10),14);
